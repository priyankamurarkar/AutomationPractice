...
public class Example3 {
	...
	public static void main(String[] args) {
		...
		List<WebElement> sugg = driver.findElements(By.cssSelector("ul>li>div>div:nth-of-type(2)>div.wM6W7d>span"));
		System.out.println("Suggestion count: " + sugg.size());
		for (int i = 0; i < sugg.size(); i++) {
			// to avoid SteleElementException, re-identify all the suggestions
			sugg = driver.findElements(By.cssSelector("ul>li>div>div:nth-of-type(2)>div.wM6W7d>span"));
			System.out.println(sugg.get(i).getText());
			// ul>li>div>div:nth-of-type(2)>div.wM6W7d>span
		}
